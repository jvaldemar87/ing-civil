export const translations = {
    es: {
        ...
        'project.detail.breadcrumb': 'Proyectos',
        'project.detail.technical.info': 'Información Técnica',
        'project.detail.description': 'Descripción del Proyecto',
        'project.detail.related': 'Proyectos Relacionados',
        'project.detail.gallery': 'Galería de Imágenes',
        'project.detail.location': 'Ubicación',
        'project.detail.type': 'Tipo de Proyecto',
        'project.detail.tags': 'Categorías',
        'project.detail.image.of': 'de',
        'project.detail.no.images': 'Imágenes próximamente',
    ...
    en: {
        ...
        'project.datasheet': 'Technical Data',
        'project.client': 'Client',
        'project.detail.title': 'Project Details',
        'project.detail.breadcrumb': 'Projects',
        'project.detail.technical.info': 'Technical Information',
        'project.detail.description': 'Project Description',
        'project.detail.related': 'Related Projects',
        'project.detail.gallery': 'Image Gallery',
        'project.detail.location': 'Location',
        'project.detail.type': 'Project Type',
        'project.detail.tags': 'Categories',
        'project.detail.image.of': 'of',
        'project.detail.no.images': 'Images coming soon',
